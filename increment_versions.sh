...
# Jenkinsfile path
jenkinsfile_path="/home/jenkins/agent/workspace/new/Jenkinsfile"

# Chart.yaml path
chart_yaml_path="/home/jenkins/agent/workspace/new/my_react_chart/Chart.yaml"

# Deployment.yaml path
deployment_yaml_path="/home/jenkins/agent/workspace/new/my_react_chart/templates/deployment.yaml"
